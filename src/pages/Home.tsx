...
const Home = () => {
    return (
        <>
            <section className="banner flex flex-col justify-center my-50 h-800 bg-center bg-cover bg-no-repeat text-center text-white-100 tracking-widest uppercase"
                style={{ backgroundImage: `url(${Banner})` }}>
                <p className="text-6xl z-10">alumina:</p>
                <p className="text-7xl z-10 my-50">качественный товар</p>
                <p className="text-5xl z-10">по доступным ценам</p>
            </section>
